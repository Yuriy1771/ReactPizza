...
const PizzaCard = ({price, title, imgUrl, sizes, types}) => {
                ...
                <div className="pizza-block__selector">
                    <ul>
                        {types.map((type, index) => <li onClick={() => setCurIndexPizzaType(index)}
                                                        className={index === curIndexPizzaType ? 'active' : ''}
                                                        key={index}>{typePizzas[type]}</li>)}
                    </ul>
                    <ul>
                        {sizes.map((size, index) => <li onClick={() => setCurIndexPizzaSize(index)}
                                                        className={index === curIndexPizzaSize ? 'active' : ''}
